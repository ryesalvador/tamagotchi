...
def main():
    ...
    selector_img = pygame.image.load('assets/selector.png')
    ...
    while True:
        ...
        # Render components
        z = zip(['feed.png', 'flush.png', 'health.png', 'zzz.png'], [i for i in range(64, 320, 64)])
        for i in range(len(z)):
            img = pygame.Surface((32, 32))
            sprite = pygame.image.load('assets/%s' % z[i][0])
            screen.blit(sprite, (z[i][1], 16))

        # Render selector
        screen.blit(selector_img, (64+(selid*64), 16))
